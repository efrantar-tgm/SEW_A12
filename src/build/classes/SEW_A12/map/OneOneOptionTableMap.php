...
/**
 * This class defines the structure of the 'oneOneOptions' table.
 *
 *
 *
 ...
 */
class OneOneOptionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'SEW_A12.map.OneOneOptionTableMap';
    ...
    {
        // attributes
        $this->setName('oneOneOptions');
        $this->setPhpName('OneOneOption');
        $this->setClassname('OneOneOption');
