...
abstract class BaseCommentPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Content', 'Posttime', 'Username', 'Eventid', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'content', 'posttime', 'username', 'eventid', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::CONTENT, CommentPeer::POSTTIME, CommentPeer::USERNAME, CommentPeer::EVENTID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CONTENT', 'POSTTIME', 'USERNAME', 'EVENTID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'content', 'postTime', 'username', 'eventid', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Content' => 1, 'Posttime' => 2, 'Username' => 3, 'Eventid' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'content' => 1, 'posttime' => 2, 'username' => 3, 'eventid' => 4, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::CONTENT => 1, CommentPeer::POSTTIME => 2, CommentPeer::USERNAME => 3, CommentPeer::EVENTID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CONTENT' => 1, 'POSTTIME' => 2, 'USERNAME' => 3, 'EVENTID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'content' => 1, 'postTime' => 2, 'username' => 3, 'eventid' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentPeer::POSTTIME);
            $criteria->addSelectColumn(CommentPeer::USERNAME);
            $criteria->addSelectColumn(CommentPeer::EVENTID);
        } else {
    ...
    public static function doCountJoinMyUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::USERNAME, MyUserPeer::NAME, $join_behavior);
    ...
    public static function doCountJoinEvent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::EVENTID, EventPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their MyUser objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMyUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (MyUser)
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Event objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Comment objects.
    ...
    public static function doSelectJoinEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Event)
                $obj2->addComment($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (MyUser)
                $obj2->addComment($obj1);
          ...
          $cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);
                ...
                // Add the $obj1 (Comment) to the collection in $obj3 (Event)
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except MyUser.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptMyUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Event)
                $obj2->addComment($obj1);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except Event.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
